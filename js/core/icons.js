...
const P = {
  ...
  edit: '<path d="M4 20h4.2L19 9.2a2.1 2.1 0 0 0-3-3L5.2 17z"/><path d="M14.6 7.6l2.8 2.8"/>',
  mosque: '<path d="M12 2.6c2.7 2.1 4.3 4.4 4.3 6.8H7.7c0-2.4 1.6-4.7 4.3-6.8Z"/><path d="M3.6 21.4v-7.2a2 2 0 0 1 2-2h12.8a2 2 0 0 1 2 2v7.2"/><path d="M2.6 21.4h18.8"/><path d="M9.4 21.4v-3.6a2.6 2.6 0 0 1 5.2 0v3.6"/><path d="M6 12.2V9.4M18 12.2V9.4"/>',
